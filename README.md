...
1- First step would be to enable SSH on both MNs, and edit user permissions.
...
2- Now we have to set up a list of Hosts for the CN to use, so, we will create the following structure and file (if its not already there)
